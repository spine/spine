...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.fromForm = function(form) {
      var checkbox, key, result, _i, _j, _k, _l, _len, _len1, _len2, _len3, _name, _ref, _ref1, _ref2, _ref3;
      ...
      _ref1 = $(form).find('[type=checkbox][value]');
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        checkbox = _ref1[_j];
        result[checkbox.name] = [];
      }
      _ref2 = $(form).find('[type=checkbox][value][checked]');
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        checkbox = _ref2[_k];
        result[checkbox.name].push(checkbox.value);
      }
      _ref3 = $(form).serializeArray();
