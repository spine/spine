(function() {
  ...
  Model = (function() {
    ...
    Model.prototype.attributes = function() {
      ...
      result = {};
      _ref = this.contructor.attributes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        key = _ref[_i];
        result[key] = this[key];
      }
    ...
    Model.prototype.eql = function(rec) {
      return rec && rec.id === this.id && rec.parent === this.contructor;
    };
    ...
    Model.prototype.destroy = function() {
      ...
      delete this.contructor.records[this.id];
      this.destroyed = true;
    ...
    Model.prototype.dup = function() {
      var result;
      result = new this.contructor(this.attributes());
    ...
    Model.prototype.reload = function() {
      ...
      original = this.contructor.find(this.id);
    ...
    Model.prototype.update = function() {
      ...
      records = this.contructor.records;
    ...
    Model.prototype.bind = function(events, callback) {
      return this.contructor.bind(events, __bind(function(record) {
    ...
    Model.prototype.trigger = function() {
      return this.contructor.trigger.apply(this.contructor, arguments);
    };
    return Model;
  })();
  Model.extend(Events);
  Controller = (function() {
    ...
    function Controller(options) {
      ...
      this.el = $(this.el);
      if (!this.events) {
        this.events = this.contructor.events;
      }
      if (!this.elements) {
        this.elements = this.contructor.elements;
      }
      if (this.events) {
        this.delegateEvents();
      }
    ...
    Controller.prototype.appendTo = function() {
