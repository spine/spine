...
(function() {
  ...
  Model = (function(_super) {
    ...
    Model.prototype.fromForm = function(form) {
      var checkbox, key, result, _i, _j, _k, _len, _len1, _len2, _name, _name1, _ref, _ref1, _ref2;
      ...
      _ref1 = $(form).find('[type=checkbox][value][checked]');
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        checkbox = _ref1[_j];
        result[_name = checkbox.name] || (result[_name] = []);
        result[checkbox.name].push(checkbox.value);
      }
      _ref2 = $(form).serializeArray();
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        key = _ref2[_k];
        result[_name1 = key.name] || (result[_name1] = key.value);
      }
