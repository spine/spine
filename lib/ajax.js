  ...
  Base = (function() {
    ...
    Base.prototype.ajaxQueue = function(params, defaults, record) {
      ...
      request = function(next) {
        ...
        shouldStringify = typeof settings.data !== 'string';
        if (shouldStringify && (settings.type === 'GET' && settings.processData === true && typeof settings.data !== 'string')) {
          shouldStringify = false;
        }
        if (shouldStringify && settings.processData === false) {
