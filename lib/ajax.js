...
(function() {
  ...
  Collection = (function(_super) {
    ...
    function Collection(model) {
      this.model = model;
      this.alwaysResponse = __bind(this.alwaysResponse, this);
    ...
    Collection.prototype.all = function(params) {
      ...
      }).done(this.recordsResponse).fail(this.failResponse).always(this.alwaysResponse);
    };
    ...
    Collection.prototype.recordsResponse = function(options) {
      ...
      return function(data, status, xhr) {
        var _ref, _ref1;
        _this.model.trigger('ajaxSuccess', null, status, xhr);
        if ((_ref = options.success) != null) {
          _ref.apply(_this.model);
        }
        return (_ref1 = options.done) != null ? _ref1.apply(_this.model) : void 0;
      };
    };
    ...
    Collection.prototype.failResponse = function(options) {
      ...
      return function(xhr, statusText, error) {
        var _ref, _ref1;
        _this.model.trigger('ajaxError', null, xhr, statusText, error);
        if ((_ref = options.error) != null) {
          _ref.apply(_this.model);
        }
        return (_ref1 = options.fail) != null ? _ref1.apply(_this.model) : void 0;
      };
    };

    Collection.prototype.alwaysResponse = function(options) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      return function(xhr, statusText) {
        ...
        return (_ref1 = options.always) != null ? _ref1.apply(_this.model) : void 0;
      };
    };
  ...
  Singleton = (function(_super) {
    ...
    Singleton.prototype.ajaxSend = function(params, settings, options) {
      return this.ajaxQueue(params, settings).done(this.recordResponse(options)).fail(this.failResponse(options)).always(this.alwaysResponse(options));
    };
    ...
    Singleton.prototype.reload = function(params, options) {
      ...
      return this.ajaxSend(params, settings, options);
    };
    ...
    Singleton.prototype.alwaysResponse = function(options) {
      var _this = this;
      if (options == null) {
        options = {};
      }
      return function(xhr, statusText) {
        ...
        return (_ref1 = options.always) != null ? _ref1.apply(_this.record) : void 0;
      };
    };
