...
(function() {
  ...
  Collection = (function(_super) {
    ...
    Collection.prototype.refresh = function(values) {
      var i, match, record, records, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      ...
      for (_k = 0, _len2 = records.length; _k < _len2; _k++) {
        ...
        this.model.irecords[record.id] = record;
      }
      this.model.trigger('refresh', this.model.cloneArray(records));
      return this;
    };
